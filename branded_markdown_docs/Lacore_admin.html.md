...
```shell
curl https://lacore-sandbox.finixpayments.com/users \
    -H "Content-Type: application/vnd.json+api" \
    -u  USd6r7ERYMsK2mDUBmqWdhmk:b271aac5-6826-4d2d-af66-bf86e9ffa85b \
    -d '
	{
	    "role": "ROLE_PARTNER"
	}'
...
```json
{
  "id" : "USed8KcvU1NcqCjL2gecsdE7",
  "password" : "6bb7691d-eb11-4fba-a65e-c8f352dca244",
  "identity" : null,
  "enabled" : true,
  "role" : "ROLE_PARTNER",
  "tags" : { },
  "created_at" : "2017-11-28T02:56:58.93Z",
  "updated_at" : "2017-11-28T02:56:58.93Z",
  "_links" : {
    "self" : {
      "href" : "https://lacore-sandbox.finixpayments.com:443/users/USed8KcvU1NcqCjL2gecsdE7"
    },
    "applications" : {
      "href" : "https://lacore-sandbox.finixpayments.com:443/applications"
    }
  }
}
```
...
`POST https://lacore-sandbox.finixpayments.com/users`
...
```shell
curl https://lacore-sandbox.finixpayments.com/applications/ \
    -H "Content-Type: application/vnd.json+api" \
    -u  USd6r7ERYMsK2mDUBmqWdhmk:b271aac5-6826-4d2d-af66-bf86e9ffa85b \
    -d '
	{
...
```json
{
  "id" : "AP3VrWhf2cFx5QakKk5UrT3f",
  "enabled" : true,
  "tags" : {
    "application_name" : "HyperWallet"
  },
  "owner" : "IDmuTMfuKfvVVQiaEWXLHZNK",
  "processing_enabled" : false,
  "settlement_enabled" : false,
  "created_at" : "2017-11-28T02:57:00.35Z",
  "updated_at" : "2017-11-28T02:57:00.35Z",
  "_links" : {
    "self" : {
      "href" : "https://lacore-sandbox.finixpayments.com:443/applications/AP3VrWhf2cFx5QakKk5UrT3f"
    },
    "processors" : {
      "href" : "https://lacore-sandbox.finixpayments.com:443/applications/AP3VrWhf2cFx5QakKk5UrT3f/processors"
    },
    "users" : {
      "href" : "https://lacore-sandbox.finixpayments.com:443/applications/AP3VrWhf2cFx5QakKk5UrT3f/users"
    },
    "owner_identity" : {
      "href" : "https://lacore-sandbox.finixpayments.com:443/identities/IDmuTMfuKfvVVQiaEWXLHZNK"
    },
    "transfers" : {
      "href" : "https://lacore-sandbox.finixpayments.com:443/applications/AP3VrWhf2cFx5QakKk5UrT3f/transfers"
    },
    "disputes" : {
      "href" : "https://lacore-sandbox.finixpayments.com:443/applications/AP3VrWhf2cFx5QakKk5UrT3f/disputes"
    },
    "authorizations" : {
      "href" : "https://lacore-sandbox.finixpayments.com:443/applications/AP3VrWhf2cFx5QakKk5UrT3f/authorizations"
    },
    "settlements" : {
      "href" : "https://lacore-sandbox.finixpayments.com:443/applications/AP3VrWhf2cFx5QakKk5UrT3f/settlements"
    },
    "merchants" : {
      "href" : "https://lacore-sandbox.finixpayments.com:443/applications/AP3VrWhf2cFx5QakKk5UrT3f/merchants"
    },
    "identities" : {
      "href" : "https://lacore-sandbox.finixpayments.com:443/applications/AP3VrWhf2cFx5QakKk5UrT3f/identities"
    },
    "webhooks" : {
      "href" : "https://lacore-sandbox.finixpayments.com:443/applications/AP3VrWhf2cFx5QakKk5UrT3f/webhooks"
    },
    "reversals" : {
      "href" : "https://lacore-sandbox.finixpayments.com:443/applications/AP3VrWhf2cFx5QakKk5UrT3f/reversals"
    },
    "tokens" : {
      "href" : "https://lacore-sandbox.finixpayments.com:443/applications/AP3VrWhf2cFx5QakKk5UrT3f/tokens"
    },
    "application_profile" : {
      "href" : "https://lacore-sandbox.finixpayments.com:443/applications/AP3VrWhf2cFx5QakKk5UrT3f/application_profile"
    }
  }
}
```
...
`POST https://lacore-sandbox.finixpayments.com/applications`
...
```shell
curl https://lacore-sandbox.finixpayments.com/applications/AP3VrWhf2cFx5QakKk5UrT3f/processors \
    -H "Content-Type: application/vnd.json+api" \
    -u  USd6r7ERYMsK2mDUBmqWdhmk:b271aac5-6826-4d2d-af66-bf86e9ffa85b \
    -d '
	{
...
```json
{
  "id" : "PRszBFNLYgnqKZ1uvcuBbG7p",
  "application" : "AP3VrWhf2cFx5QakKk5UrT3f",
  "default_merchant_profile" : "MPsvKLuHZHmh64hANixH1hk",
  "created_at" : "2017-11-28T02:57:01.54Z",
  "updated_at" : "2017-11-28T02:57:01.54Z",
  "processor" : "DUMMY_V1",
  "config" : {
    "key1" : "value-1",
    "key2" : "value-2",
  ...
  "_links" : {
    "self" : {
      "href" : "https://lacore-sandbox.finixpayments.com:443/applications/AP3VrWhf2cFx5QakKk5UrT3f/processors/DUMMY_V1"
    },
    "application" : {
      "href" : "https://lacore-sandbox.finixpayments.com:443/applications/AP3VrWhf2cFx5QakKk5UrT3f"
    }
...
The Lacore Payment Platform is processor agnostic allowing for processing transactions
...
`POST https://lacore-sandbox.finixpayments.com/applications/:APPLICATION_ID/processors`
...
```shell
curl https://lacore-sandbox.finixpayments.com/applications/AP3VrWhf2cFx5QakKk5UrT3f/ \
    -H "Content-Type: application/vnd.json+api" \
    -u  USd6r7ERYMsK2mDUBmqWdhmk:b271aac5-6826-4d2d-af66-bf86e9ffa85b \
    -X PUT \
    -d '
...
```json
{
  ...
  "settlement_enabled" : false,
  "created_at" : "2017-11-28T02:57:00.35Z",
  "updated_at" : "2017-11-28T03:00:53.75Z",
  "_links" : {
    "self" : {
      "href" : "https://lacore-sandbox.finixpayments.com:443/applications/AP3VrWhf2cFx5QakKk5UrT3f"
    },
...
`PUT https://lacore-sandbox.finixpayments.com/applications/:APPLICATION_ID`
...
```json
{
  ...
  "settlement_enabled" : true,
  "created_at" : "2017-11-28T02:57:00.35Z",
  "updated_at" : "2017-11-28T03:00:54.49Z",
  "_links" : {
    "self" : {
      "href" : "https://lacore-sandbox.finixpayments.com:443/applications/AP3VrWhf2cFx5QakKk5UrT3f"
    },
...
To ensure that you remain PCI compliant, please use tokenization.js to tokenize cards and bank accounts. Tokenization.js ensures sensitive card data never touches your servers and keeps you out of PCI scope by sending this info over SSL directly to Lacore.
...
var initTokenization = function() {
  Tokenization.init({
    server: "https://lacore-sandbox.finixpayments.com",
    applicationId: "AP3VrWhf2cFx5QakKk5UrT3f",
    hosted_fields: {
      card: {
        number: {
...
Field | Type | Description
----- | ---- | -----------
server | *string*, **required** |  The base url for the Lacore API
...
$application = Application::retrieve('AP3VrWhf2cFx5QakKk5UrT3f');

```
```python


from lacore.resources import Application

application = Application.get(id="AP3VrWhf2cFx5QakKk5UrT3f")
```
```ruby
...
```json
{
  ...
  "settlement_enabled" : true,
  "created_at" : "2017-11-28T02:57:00.35Z",
  "updated_at" : "2017-11-28T02:57:04.37Z",
  "_links" : {
    "self" : {
      "href" : "https://lacore-sandbox.finixpayments.com:443/applications/AP3VrWhf2cFx5QakKk5UrT3f"
    },
...
`GET https://lacore-sandbox.finixpayments.com/applications/:APPLICATION_ID`
...
```json
{
  ...
  "settlement_enabled" : true,
  "created_at" : "2017-11-28T02:57:00.35Z",
  "updated_at" : "2017-11-28T03:00:50.08Z",
  "_links" : {
    "self" : {
      "href" : "https://lacore-sandbox.finixpayments.com:443/applications/AP3VrWhf2cFx5QakKk5UrT3f"
    },
...
```json
{
  ...
  "settlement_enabled" : false,
  "created_at" : "2017-11-28T02:57:00.35Z",
  "updated_at" : "2017-11-28T03:00:51.01Z",
  "_links" : {
    "self" : {
      "href" : "https://lacore-sandbox.finixpayments.com:443/applications/AP3VrWhf2cFx5QakKk5UrT3f"
    },
...
```shell
curl https://lacore-sandbox.finixpayments.com/applications/AP3VrWhf2cFx5QakKk5UrT3f/users \
    -H "Content-Type: application/vnd.json+api" \
    -u  USed8KcvU1NcqCjL2gecsdE7:6bb7691d-eb11-4fba-a65e-c8f352dca244 \
    -d '{}'
...
```json
{
  "id" : "US5uNSj6wkUH6TGzukwSqfZD",
  "password" : "09bc12ec-87ed-4ec1-b640-a4d0e83a8629",
  "identity" : "IDmuTMfuKfvVVQiaEWXLHZNK",
  "enabled" : true,
  "role" : "ROLE_PARTNER",
  "tags" : { },
  "created_at" : "2017-11-28T02:57:02.46Z",
  "updated_at" : "2017-11-28T02:57:02.46Z",
  "_links" : {
    "self" : {
      "href" : "https://lacore-sandbox.finixpayments.com:443/users/US5uNSj6wkUH6TGzukwSqfZD"
    },
    "applications" : {
      "href" : "https://lacore-sandbox.finixpayments.com:443/applications"
    },
...
`POST https://lacore-sandbox.finixpayments.com/applications/:APPLICATION_ID/users`
...
```json
{
  ...
  "_links" : {
    "self" : {
      "href" : "https://lacore-sandbox.finixpayments.com/applications/?offset=0&limit=20&sort=created_at,desc"
    }
  },
  "page" : {
    "offset" : 0,
...
`GET https://lacore-sandbox.finixpayments.com/applications/`
...
```json
{
  ...
  "tags" : { },
  "created_at" : "2017-11-28T02:57:17.91Z",
  "updated_at" : "2017-11-28T03:00:48.39Z",
  "onboarding_state" : "APPROVED",
  "_links" : {
    "self" : {
      "href" : "https://lacore-sandbox.finixpayments.com:443/merchants/MUc9AnmXPDqA3V332VcpxaWM"
...
`PUT https://lacore-sandbox.finixpayments.com/merchants/:MERCHANT_ID`
...
```json
{
  ...
  "tags" : { },
  "created_at" : "2017-11-28T02:57:17.91Z",
  "updated_at" : "2017-11-28T03:00:49.22Z",
  "onboarding_state" : "APPROVED",
  "_links" : {
    "self" : {
      "href" : "https://lacore-sandbox.finixpayments.com:443/merchants/MUc9AnmXPDqA3V332VcpxaWM"
...
```shell
curl https://lacore-sandbox.finixpayments.com/identities/IDwdNkeVs6byLWrz3Fe44kDv/users \
    -H "Content-Type: application/vnd.json+api" \
    -u  USed8KcvU1NcqCjL2gecsdE7:6bb7691d-eb11-4fba-a65e-c8f352dca244 \
    -d '{}'
...
```json
{
  "id" : "UStC1GyX6ADxxgkxny4CbBS1",
  "password" : "3f83f03a-99c5-487a-a803-a6a08590d882",
  "identity" : "IDwdNkeVs6byLWrz3Fe44kDv",
  "enabled" : true,
  "role" : "ROLE_MERCHANT",
  "tags" : { },
  "created_at" : "2017-11-28T02:57:24.07Z",
  "updated_at" : "2017-11-28T02:57:24.07Z",
  "_links" : {
    "self" : {
      "href" : "https://lacore-sandbox.finixpayments.com:443/users/UStC1GyX6ADxxgkxny4CbBS1"
    },
    "applications" : {
      "href" : "https://lacore-sandbox.finixpayments.com:443/applications"
    },
...
`POST https://lacore-sandbox.finixpayments.com/identities/:IDENTITY_ID/users`
...
`PUT https://lacore-sandbox.finixpayments.com/settlements/:SETTLEMENT_ID`
...
authenticated requests against the Lacore API. When making authenticated
...
```shell
curl https://lacore-sandbox.finixpayments.com/users/USed8KcvU1NcqCjL2gecsdE7 \
    -H "Content-Type: application/vnd.json+api" \
    -u  USd6r7ERYMsK2mDUBmqWdhmk:b271aac5-6826-4d2d-af66-bf86e9ffa85b
...
from lacore.resources import User
user = User.get(id="USed8KcvU1NcqCjL2gecsdE7")
...
`GET https://lacore-sandbox.finixpayments.com/users/user_id`
...
## Disable a User
```shell
curl https://lacore-sandbox.finixpayments.com/users/UStC1GyX6ADxxgkxny4CbBS1 \
    -H "Content-Type: application/vnd.json+api" \
    -u  USed8KcvU1NcqCjL2gecsdE7:6bb7691d-eb11-4fba-a65e-c8f352dca244 \
    -X PUT \
    -d '
...
```json
{
  ...
  "role" : "ROLE_MERCHANT",
  "tags" : { },
  "created_at" : "2017-11-28T02:57:24.05Z",
  "updated_at" : "2017-11-28T02:57:25.34Z",
  "_links" : {
    "self" : {
      "href" : "https://lacore-sandbox.finixpayments.com:443/users/UStC1GyX6ADxxgkxny4CbBS1"
    },
...
`PUT https://lacore-sandbox.finixpayments.com/users/user_id`
...
```json
{
  "_embedded" : {
    "users" : [ {
      ...
      "tags" : { },
      "created_at" : "2017-11-28T02:57:24.05Z",
      "updated_at" : "2017-11-28T02:57:26.13Z",
      "_links" : {
        "self" : {
          "href" : "https://lacore-sandbox.finixpayments.com:443/users/UStC1GyX6ADxxgkxny4CbBS1"
        },
      ...
      "role" : "ROLE_PARTNER",
      "tags" : { },
      "created_at" : "2017-11-28T02:57:02.45Z",
      "updated_at" : "2017-11-28T02:57:02.45Z",
      "_links" : {
        "self" : {
          "href" : "https://lacore-sandbox.finixpayments.com:443/users/US5uNSj6wkUH6TGzukwSqfZD"
        },
  ...
  "_links" : {
    "self" : {
      "href" : "https://lacore-sandbox.finixpayments.com/users/?offset=0&limit=20&sort=created_at,desc"
    }
  },
  "page" : {
    "offset" : 0,
...
`GET https://lacore-sandbox.finixpayments.com/users`
