...
def generate_template_variables(config_values):
    ...
    enable_sale_scenario = api_client.enable_sale(create_app_scenario["response_id"])
    ...
    create_bank_debit_split_payout_scenario = api_client.create_debit(create_identity_corporation_scenario['response_id'], create_buyer_bank_account_scenario["response_id"], random.randint(100, 900000))
    ...
    create_bank_debit_idempotency_scenario = api_client.create_debit_idempotency(create_identity_individual_sole_proprietorship_scenario['response_id'], create_card_scenario["response_id"], random.randint(100, 900000))
    ...
    create_authorization_idempotency_scenario = api_client.create_authorization_idempotency(create_identity_individual_sole_proprietorship_scenario['response_id'], create_card_scenario["response_id"])
    ...
    # create_merchant_fee_profile_scenario = api_client.create_fee_profile(fetch_merchant_scenario["response_id"])
    create_merchant_fee_profile_scenario = api_client.create_fee_profile(fetch_application_scenario["response_id"])

    # create_merchant_fee_profile_tiered_billing_scenario = api_client.create_fee_profile(fetch_merchant_scenario["response_id"], "merchant-tiered")
    ...
    api_scenario_vars = {
        ...
        "provision_merchant_settle_upon_scenario_curl_request": provision_merchant_settle_upon_scenario["curl_request_body"],
        "provision_merchant_settle_upon_scenario_ruby_request": provision_merchant_settle_upon_scenario["ruby_request_body"],
        "provision_merchant_settle_upon_scenario_python_request": provision_merchant_settle_upon_scenario["python_request_body"],
        "provision_merchant_settle_upon_scenario_response": provision_merchant_settle_upon_scenario["response_body"],
        "provision_merchant_settle_upon_scenario_id": provision_merchant_settle_upon_scenario["response_id"],

        "merchant_settle_upon_scenario_curl_request": merchant_settle_upon_scenario["curl_request_body"],
        "merchant_settle_upon_scenario_php_request": merchant_settle_upon_scenario["php_request_body"],
        "merchant_settle_upon_scenario_ruby_request": merchant_settle_upon_scenario["ruby_request_body"],
        "merchant_settle_upon_scenario_python_request": merchant_settle_upon_scenario["python_request_body"],
        "merchant_settle_upon_scenario_response": merchant_settle_upon_scenario["response_body"],
        "merchant_settle_upon_scenario_id": merchant_settle_upon_scenario["response_id"],

        "fetch_merchant_settle_upon_scenario_response": fetch_merchant_settle_upon_scenario["response_body"],
        "fetch_merchant_settle_upon_scenario_id": fetch_merchant_settle_upon_scenario["response_id"],
        # "fetch_merchant_settle_upon_scenario_curl_request": fetch_merchant_settle_upon_scenario["curl_request_body"],
        ...
        "create_sale_scenario_php_request": create_sale_scenario["php_request_body"],
        "create_sale_scenario_ruby_request": create_sale_scenario["php_request_body"],
        "create_sale_scenario_python_request": create_sale_scenario["python_request_body"],
        "create_sale_scenario_response": create_sale_scenario["response_body"],
        "create_sale_scenario_id": create_sale_scenario["response_id"],


        "create_bank_debit_idempotency_scenario_curl_request": create_bank_debit_idempotency_scenario["curl_request_body"],
        "create_bank_debit_idempotency_scenario_php_request": create_bank_debit_idempotency_scenario["php_request_body"],
        "create_bank_debit_idempotency_scenario_ruby_request": create_bank_debit_idempotency_scenario["ruby_request_body"],
        "create_bank_debit_idempotency_scenario_python_request": create_bank_debit_idempotency_scenario["python_request_body"],
        ...
        "create_refund_aft_scenario_ruby_request": create_refund_aft_scenario["php_request_body"],
        ...
        # "create_recipient_card_verification_scenario_id": create_recipient_card_verification_scenario["response_id"],
        ...
        "create_authorization_idempotency_scenario_curl_request": create_authorization_idempotency_scenario["curl_request_body"],
        "create_authorization_idempotency_scenario_php_request": create_authorization_idempotency_scenario["php_request_body"],
        "create_authorization_idempotency_scenario_ruby_request": create_authorization_idempotency_scenario["ruby_request_body"],
        "create_authorization_idempotency_scenario_python_request": create_authorization_idempotency_scenario["python_request_body"],
        "create_authorization_idempotency_scenario_response": create_authorization_idempotency_scenario["response_body"],
        "create_authorization_idempotency_scenario_id": create_authorization_idempotency_scenario["response_id"],
        "create_authorization_idempotency_scenario_idempotency_id": json.loads(create_authorization_idempotency_scenario["response_body"])["idempotency_id"],
        ...
        # "create_settlement_split_payout_scenario_curl_request": create_settlement_split_payout_scenario["curl_request_body"],
        # "create_settlement_split_payout_scenario_php_request": create_settlement_split_payout_scenario["php_request_body"],
        # "create_settlement_split_payout_scenario_ruby_request": create_settlement_split_payout_scenario["ruby_request_body"],
        # "create_settlement_split_payout_scenario_python_request": create_settlement_split_payout_scenario["python_request_body"],
        # "create_settlement_split_payout_scenario_response": create_settlement_split_payout_scenario["response_body"],
        # "create_settlement_split_payout_scenario_id": create_settlement_split_payout_scenario["response_id"],
        #
        # "fund_settlement_split_payout_scenario_curl_request": fund_settlement_split_payout_scenario["curl_request_body"],
        # "fund_settlement_split_payout_scenario_php_request": fund_settlement_split_payout_scenario["php_request_body"],
        # "fund_settlement_split_payout_scenario_ruby_request": fund_settlement_split_payout_scenario["ruby_request_body"],
        # "fund_settlement_split_payout_scenario_python_request": fund_settlement_split_payout_scenario["python_request_body"],
        ...
        "fetch_settlement_by_id_scenario_response" : fetch_settlement_by_id_scenario["response_body"],
        "fetch_settlement_by_id_scenario_id" : fetch_settlement_by_id_scenario["response_id"],

        #"fetch_funding_instructions_by_settlement_scenario_response" : fetch_funding_instructions_by_settlement_scenario["response_body"],
        #"fetch_funding_instructions_by_settlement_scenario_id" : fetch_funding_instructions_by_settlement_scenario["response_id"],

        #"fetch_settlement_fees_scenario_response" : fetch_settlement_fees_scenario["response_body"],
        #"fetch_settlement_fees_scenario_id" : fetch_settlement_fees_scenario["response_id"],

        "list_fees_response" : list_fees['response_body'],

        "fetch_fees_by_id_scenario_response" : fetch_fees_by_id_scenario["response_body"],
        "fetch_fees_by_id_scenario_id" : fetch_fees_by_id_scenario["response_id"],
        ...
        "review_queue_filter_scenario_id" : json.loads(review_queue_filter_scenario["response_body"])["_embedded"]["review_queue_items"][0]["entity_id"],
        ...
        "enable_sale_scenario_curl_request": enable_sale_scenario["curl_request_body"],
        "enable_sale_scenario_response": enable_sale_scenario["response_body"],
        ...
        "create_payouts_app_scenario_curl_request": create_payouts_app_scenario["curl_request_body"],
        ...
        "create_owner_user_payouts_scenario_curl_request": create_owner_user_payouts_scenario["curl_request_body"],
        "create_owner_user_payouts_scenario_php_request": create_owner_user_payouts_scenario["php_request_body"],
        "create_owner_user_payouts_scenario_ruby_request": create_owner_user_payouts_scenario["ruby_request_body"],
        "create_owner_user_payouts_scenario_python_request": create_owner_user_payouts_scenario["python_request_body"],
        "create_owner_user_payouts_scenario_response": create_owner_user_payouts_scenario["response_body"],
        "create_owner_user_payouts_scenario_id": create_owner_user_payouts_scenario["response_id"],
        "create_owner_user_payouts_scenario_password": json.loads(create_owner_user_payouts_scenario["response_body"])['password'],
        ...
        # "create_merchant_fee_profile_tiered_billing_scenario_curl_request": create_merchant_fee_profile_tiered_billing_scenario["curl_request_body"],
        # "create_merchant_fee_profile_tiered_billing_scenario_php_request": create_merchant_fee_profile_tiered_billing_scenario['php_request_body'],
        # "create_merchant_fee_profile_tiered_billing_scenario_ruby_request": create_merchant_fee_profile_tiered_billing_scenario['ruby_request_body'],
        # 'create_merchant_fee_profile_tiered_billing_scenario_response': create_merchant_fee_profile_tiered_billing_scenario['response_body'],
        # 'create_merchant_fee_profile_tiered_billing_scenario_python_request': create_merchant_fee_profile_tiered_billing_scenario['python_request_body'],
        # 'create_merchant_fee_profile_tiered_billing_scenario_response_id': create_merchant_fee_profile_tiered_billing_scenario['response_id'],
        ...
        "update_risk_profile_scenario_curl_request": update_risk_profile_scenario['curl_request_body'],
        "update_risk_profile_scenario_php_request": update_risk_profile_scenario['php_request_body'],
        'update_risk_profile_scenario_ruby_request': update_risk_profile_scenario['ruby_request_body'],
        'update_risk_profile_scenario_python_request': update_risk_profile_scenario['python_request_body'],
        'update_risk_profile_scenario_response': update_risk_profile_scenario['response_body'],
        'update_risk_profile_scenario_response_id': update_risk_profile_scenario['response_id'],
