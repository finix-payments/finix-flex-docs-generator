...
def generate_template_variables(config_values):
    ...
    print config_values["basic_auth_username_payouts"]
    ...
    print config_values["basic_auth_password_payouts"]
    ...
    create_recipient_card_scenario = api_client.create_card(create_recipient_identity_payouts_scenario["response_id"], '4957030420210454', 'CAD', 'payouts')
    # print "-----------------------------------------------------"
    create_sender_card_scenario = api_client.create_card(create_sender_identity_payouts_scenario["response_id"], '4957030005123353', 'CAD', 'payouts')
    ...
    #
    toggle_application_processing_scenario = api_client.toggle_application_processing(create_payouts_app_scenario["response_id"], False, 'payouts')
    # toggle_on_application_processing_scenario = api_client.toggle_application_processing(create_payouts_app_scenario["response_id"], True, 'payouts')
