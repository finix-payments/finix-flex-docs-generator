...
admin_snippets_by_resource = {
    ...
    "subscription_billing": [
        ...
        "fetch_subscription_schedule_filters",
        "create_subscription_plan",
        "fetch_subscription_plan",
        "fetch_subscription_plan_filters",
        "create_subscription_group",
        "fetch_subscription_group",
        "fetch_subscription_group_filters",
        "update_subscription_group",
        "fetch_subscription_group_history_filters",
        "create_subscription_item",
        "fetch_subscription_item",
        "fetch_subscription_item_filters",
        "delete_subscription_item",
        "fetch_subscription_item_task_filters",
    ],
    "guide_tokenization_js": [
        "definition",
        "associate_token",
